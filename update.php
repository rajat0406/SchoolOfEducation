...
$connect = mysqli_connect("localhost", "root", "", "news");  
 ...
 { 
 	...
 	$inputtitle = mysqli_escape_string($connect,$_POST["newtitle"]);
    //$inputdescription = mysqli_escape_string($connect,$_POST["description"]); 

    $query="UPDATE tbl_images SET title='$inputtitle' WHERE title='$usertitle'";
...
<body >
	...
	<h2 style = "color: black;text-align: center ; font-size: 250%;">Update News</h2>
	<table style="background-color: White">	
	<tr><th>Title:</th><td><input type="text" name="title" placeholder="Enter old title" required></td></tr>
	<!--tr><th>New Image:</th><td><input type="file" name="file" id="file"></td></tr-->	
	<tr><th>New Title:</th><td><input type="text" name="newtitle" id="title" placeholder="Enter New Title" ></td></tr>		
    <!--tr><th>New Description:</th><td><textarea name="description" id="description" placeholder="Enter News Description"></textarea></td></tr-->
	</table>
	<br>
	...
	<h>Do you want to add news?</h><br>
	...
	<button type="submit" onclick="window.location.href='delete.php'" style="background-color: Red; font-size: 20px; width:200px">Delete</button><br>
	</div>
	</center>
